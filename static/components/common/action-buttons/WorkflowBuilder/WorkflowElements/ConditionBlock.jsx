...
import { X, ChevronDown, Trash2, GitMerge, FileText, FileEdit } from 'lucide-react';
...
const ConditionBlock = ({
  ...
  // Add sub-condition options
  const addOptions = [
    { label: 'Add Approver', value: 'add-approver' },
    { label: 'Add Required Fields', value: 'add-required-fields' },
    { label: 'Add Optional Fields', value: 'add-optional-fields' }
  ];
      ...
      <div className="flex items-start">
        ...
        <div
          className={`condition-content flex-grow rounded-lg border ${
            isHovered ? 'border-blue-400 shadow-sm' : 'border-gray-200'
          } p-3`}
        >
          {/* Condition text */}
              ...
              {isHovered && (
                <>
                  ...
                  <div className="relative">
                    ...
                    {showActionsDropdown && (
                      <div className="absolute z-10 mt-1 w-48 bg-white border border-gray-200 rounded-md shadow-lg right-0">
                        <div className="py-1">
                          <AddButton
                            options={addOptions}
                            onOptionSelect={(option) => {
                              onAddSubCondition(option);
